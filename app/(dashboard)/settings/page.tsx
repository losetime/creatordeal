                ...
                <CardContent className="space-y-4">
                  <div className="rounded-lg p-4 bg-slate-50">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="font-semibold">{planLabel} Plan â€?$9.90/mo</p>
                      ...
                      <div className="flex gap-2">
                        {profile?.plan !== "pro" && (
                          <>
                            <Button onClick={handleUpgrade}>Subscribe â€?$9.90/mo</Button>
                    ...
                    <div className="divide-y">
                      <div className="flex items-center justify-between p-4 hover:bg-slate-50 transition-colors">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <p className="text-sm font-medium">Creator Club â€?Monthly</p>
                            <p className="text-xs text-muted-foreground">
                              {profile.payment_submitted_at ? formatDate(profile.payment_submitted_at) : "â€?}
                            </p>
                          </div>
                        </div>
                        <div className="flex items-center gap-3">
